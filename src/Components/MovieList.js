...
const MovieList = () => {
    ...
    const [list, setList] = useState([
        {posterURL:"https://i5.walmartimages.com/asr/9ab25da7-1863-47ec-b256-bef7f0b384d6_1.eff76dd1d07d4d50c798b93b306f5f64.jpeg",trailerURL: "https://www.youtube.com/embed/2xb9Ty-1frw?autoplay=1",title:"Titanic",description:"Film 2018",rating:5,id:1},
        {posterURL:"https://fr.web.img5.acsta.net/pictures/21/05/18/10/40/2487837.jpg",trailerURL: "https://www.youtube.com/embed/2xb9Ty-1frw?autoplay=1",title:"Fast and furious",description:"Film 2019",rating:0,id:2},
        {posterURL:"https://static.kino.de/wp-content/uploads/2010/08/House-of-Gucci-Poster-2021-rcm400x400u.jpg",title:"Twilight",trailerURL: "https://www.youtube.com/embed/2xb9Ty-1frw?autoplay=1",description:"Film 2020",rating:0,id:3},
    ])
...
const addMovie = ()=>{
    setList([...list, {posterURL,title,description,rating,trailerURL}])
}
